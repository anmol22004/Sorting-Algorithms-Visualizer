...
public class sorting {
	...
	private String[] algorithms = {"Selection Sort", "Bubble Sort","Insertion Sort","Quick Sort", "Heap Sort", "Merge Sort"};
	...
	JSlider speed = new JSlider(JSlider.HORIZONTAL,0,50,spd);
	//BORDER STYLE
	...
	public void initialize() {
		...
		credit.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(jf, "Anmol Agarwal(2K18/CO/074) & Arpit Yadav(2K18/C0/091)", "Credits", JOptionPane.PLAIN_MESSAGE, new ImageIcon(""));
			}
		});
